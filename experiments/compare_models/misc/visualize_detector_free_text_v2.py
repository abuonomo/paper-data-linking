"""
Visualize detector_free_text_v2 self-consistency results across runs.
"""
import json
...
def main():
    experiment_dir = Path("experiments/compare_models/prompt_experiments/detector_free_text_v2_bedrock_120b_full")
    ...
    # Save figure
    output_path = experiment_dir / "detector_free_text_v2_analysis.png"
