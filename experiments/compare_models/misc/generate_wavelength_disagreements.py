"""Generate HTML report for wavelength normalization disagreements."""
import json
import html
from pathlib import Path

# Paths to result files
base_dir = Path("experiments/compare_models/experiments/compare_models/prompt_experiments/wavelength_10_all_models")
nano_file = base_dir / "openai_gpt-5-nano_20251009_114533.jsonl"
mini_file = base_dir / "openai_gpt-5-mini_20251009_114719.jsonl"
gpt5_file = base_dir / "openai_gpt-5_20251009_114846.jsonl"
...
handler = WavelengthNormalizationHandler()
...
<head>
    <meta charset="UTF-8">
    <title>Wavelength Normalization Disagreements (3 Models)</title>
    <style>
        body {
...
<body>
    <div class="header">
        <h1>Wavelength Normalization Disagreements</h1>
        <div class="stats">
            <strong>Total disagreement cases:</strong> """ + str(len(disagreements)) + """<br>
            <strong>Models compared:</strong> nano, mini, gpt-5<br>
            <strong>Note:</strong> band_name is excluded from comparison (metadata only)
        </div>
    </div>
"""
...
for disagreement in disagreements:
    ...
    <div class="case">
        ...
        <div class="section">
            ...
            <div class="responses">
                <div class="response nano">
                    <div class="response-header">nano</div>
                ...
                <div class="response mini">
                    <div class="response-header">mini</div>
                ...
                <div class="response gpt5">
                    <div class="response-header">gpt-5</div>
...
# Write HTML file
output_file = Path("experiments/compare_models/results/wavelength_disagreements_3models.html")
