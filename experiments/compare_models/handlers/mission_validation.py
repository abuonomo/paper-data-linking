"""
Handler for mission validation LLM calls.

Validates whether a proposed mission match is valid given the description.
...
class MissionValidationHandler(CallTypeHandler):
    """
    Handler for mission validation tasks.

    Expected response format from LLM:
        VALIDATION ANALYSIS:
        - Domain alignment: ... → pass/fail
        - Temporal compatibility: ... → pass/fail
        - Explicit mention: ... → pass/fail
        - Scientific capability: ... → pass/fail
